...
const en: LocaleType = {
  ...
  SdPanel: {
    ...
    QuranScenes: "Quran Scenes",
    MosqueArchitecture: "Mosque Architecture",
    IslamicCalligraphy: "Islamic Calligraphy",
    AutoGenerate: "Auto Generate Islamic Content",
    AudioTranscription: "Audio Transcription",
    RecordStory: "Record Prophet Story",
    ...
    Styles: {
      ...
      IslamicMiniature: "Islamic Miniature",
      ArabicCalligraphy: "Arabic Calligraphy",
      MosqueInterior: "Mosque Interior",
      DesertLandscape: "Desert Landscape",
      IslamicGeometric: "Islamic Geometric",
    },
  },
  Sd: {
    SubTitle: (count: number) => `${count} Islamic images`,
    Actions: {
      Params: "See Params",
      Copy: "Copy Prompt",
      Delete: "Delete",
      ...
      History: "History",
      GenerateIslamic: "Generate Islamic Image",
      StartRecording: "Start Recording",
      StopRecording: "Stop Recording",
      Transcribe: "Transcribe Audio",
    },
    EmptyRecord: "No Islamic images yet. Generate your first Islamic-themed image!",
    Status: {
      Name: "Status",
      Success: "Success",
      Error: "Error",
    ...
    Danger: {
      Delete: "Confirm to delete this Islamic image?",
    },
    GenerateParams: "Generate Params",
    Detail: "Detail",
    IslamicPrompts: {
      ProphetAdam: "Prophet Adam (AS) in Paradise, Islamic miniature style, peaceful garden, traditional Islamic art",
      ProphetNoah: "Prophet Noah (AS) building the ark, Islamic geometric patterns, traditional Islamic illustration",
      ProphetAbraham: "Prophet Abraham (AS) with celestial fire, Islamic calligraphy background, spiritual illumination",
      ProphetMoses: "Prophet Moses (AS) at Mount Sinai, Islamic desert landscape, divine revelation scene",
      ProphetJesus: "Prophet Jesus (AS) with disciples, Islamic artistic style, peaceful gathering",
      ProphetMuhammad: "Prophet Muhammad (SAW) in Medina, Islamic architectural setting, serene atmosphere",
      IslamicMosque: "Beautiful mosque architecture, Islamic geometric patterns, peaceful courtyard",
      QuranRevelation: "Angel Gabriel delivering Quran to Prophet Muhammad (SAW), Islamic miniature art",
      HajjPilgrimage: "Muslims performing Hajj, Kaaba in background, Islamic pilgrimage scene",
      IslamicGarden: "Islamic paradise garden, flowing water, Arabic calligraphy, peaceful retreat",
    },
  },
};
