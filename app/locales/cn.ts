...
const cn = {
  ...
  SdPanel: {
    ...
    IslamicArt: "伊斯兰艺术",
    QuranScenes: "古兰经场景",
    MosqueArchitecture: "清真寺建筑",
    IslamicCalligraphy: "伊斯兰书法",
    AutoGenerate: "自动生成伊斯兰内容",
    ...
    Styles: {
      ...
      PixelArt: "像素艺术",
      TileTexture: "贴图",
      IslamicMiniature: "伊斯兰微缩画",
      ArabicCalligraphy: "阿拉伯书法",
      MosqueInterior: "清真寺内部",
      DesertLandscape: "沙漠景观",
      IslamicGeometric: "伊斯兰几何",
    },
  },
  Sd: {
    ...
    Detail: "详情",
    IslamicPrompts: {
      ProphetAdam: "先知亚当（AS）在天堂，伊斯兰微缩画风格，和平花园，传统伊斯兰艺术",
      ProphetNoah: "先知努哈（AS）建造方舟，伊斯兰几何图案，传统伊斯兰插图",
      ProphetAbraham: "先知易卜拉欣（AS）与天火，伊斯兰书法背景，精神启示",
      ProphetMoses: "先知穆萨（AS）在西奈山，伊斯兰沙漠景观，神圣启示场景",
      ProphetJesus: "先知尔撒（AS）与门徒，伊斯兰艺术风格，和平聚会",
      ProphetMuhammad: "先知穆罕默德（SAW）在麦地那，伊斯兰建筑环境，宁静氛围",
      IslamicMosque: "美丽的清真寺建筑，伊斯兰几何图案，和平庭院",
      QuranRevelation: "天使吉布里勒向先知穆罕默德（SAW）传达古兰经，伊斯兰微缩画艺术",
      HajjPilgrimage: "穆斯林朝觐，克尔白在背景，伊斯兰朝圣场景",
      IslamicGarden: "伊斯兰天堂花园，流水，阿拉伯书法，宁静退隐",
    },
  },
};
